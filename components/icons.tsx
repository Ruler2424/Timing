...
export const YouTubeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} fill="currentColor" viewBox="0 0 24 24">
    <path fillRule="evenodd" d="M19.82 5.094a.5.5 0 00-.5-.5H4.68a.5.5 0 00-.5.5V18.906a.5.5 0 00.5.5h14.64a.5.5 0 00.5-.5V5.094zM9 15.5V8.5L15 12l-6 3.5z" clipRule="evenodd" />
  </svg>
);
...
export const CoffeeIcon = ({ className }: { className?: string }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M18 8c0-2.21-1.79-4-4-4H8c-2.21 0-4 1.79-4 4v10c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V8z"></path>
        <path d="M18 8h2c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2h-2"></path>
