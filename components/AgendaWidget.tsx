                                ...
                                {isEditingItem ? (
                                    ...
                                    <>
                                        ...
                                        <input
                                            ...
                                            className="flex-grow bg-transparent text-sm font-semibold focus:outline-none border-none p-0" 
                                    ...
                                    <>
                                        ...
                                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                            ...
                                            <button onClick={() => handleDelete(item.id)} aria-label="Delete item">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500 hover:text-slate-600" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-2.982l-.723-2a1 1 0 00-.894-.553H9zM7 7a1 1 0 001 1h6a1 1 0 100-2H8a1 1 0 00-1 1v6z" clipRule="evenodd"/>
                                                </svg>
                                            </button>
                                        </div>
                                    </>
