            ...
            <div className="flex flex-col"> {/* min-h-screen is handled by layout, flex flex-col is still relevant */}
                ...
                <main className="flex-grow container mx-auto p-4 sm:p-6 lg:p-8 prose">
                    ...
                    <section className="mb-8">
                        ...
                        <p className='text-[var(--text-color)]'>Your privacy is important to us. This Privacy Policy explains how Timing-Five collects, uses, discloses, and safeguards your information when you visit our website, https://timing-five.vercel.app/, including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the "Website").</p>
                    ...
                    <section className="mb-8">
                        ...
                        <p className='text-[var(--text-color)]'>We may collect your name, email address, profile picture, and other similar information that you voluntarily provide to us when you register with the site or when you choose to participate in activities such as online Q&A or newsletter subscriptions.</p>
                        ...
                        <p className='text-[var(--text-color)]'>We may automatically collect certain information when you use the Website, such as your IP address, browser type, operating system, device information, pages visited, and usage patterns. This may be collected through cookies and similar technologies.</p>
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold mb-4 text-[var(--text-color)]">3. How We Use Your Information</h2>
                        <p className='text-[var(--text-color)]'>We use the information collected to:</p>
                        <ul className="text-[var(--text-color)] list-disc list-inside space-y-2">
                    ...
                    <section className="mb-8">
                        ...
                        <p className='text-[var(--text-color)]'>We may use cookies, web beacons, and other tracking technologies to collect information about your browsing activity. You can manage your cookie preferences through your browser settings.</p>
                        {/* Explain what cookies you use and why */}
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold mb-4 text-[var(--text-color)]">5. Data Security</h2>
                        <p className='text-[var(--text-color)]'>We implement reasonable security measures to protect your personal information. However, no method of transmission over the internet or electronic storage is 100% secure.</p>
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold mb-4 text-[var(--text-color)]">6. Third-Party Services</h2>
                        <p className='text-[var(--text-color)]'>We may use third-party services that have their own privacy policies, such as Google Analytics for usage tracking or Firebase for authentication.</p>
                    ...
                    <section className="mb-8">
                        ...
                        <p className='text-[var(--text-color)]'>Depending on your location, you may have rights regarding your personal data, such as the right to access, correct, or delete your information. Contact us to exercise these rights.</p>
                    ...
                    <section className="mb-8">
                        ...
                        <p className='text-[var(--text-color)]'>We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>
                        {/* How you will notify users */}
                    </section>

                    <section className="mb-8">
                        <h2 className="text-2xl font-semibold mb-4 text-[var(--text-color)]">9. Contact Us</h2>
                        <p className='text-[var(--text-color)]'>If you have any questions about this Privacy Policy, please contact us at {contactEmail}.</p>
                    </section>
