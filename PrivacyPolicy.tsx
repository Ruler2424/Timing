...
function PrivacyPolicy() { // No 'export' here
    const pageTitle = "Privacy Policy - TimeCraft";
            ...
            <div className="min-h-screen flex flex-col">
                ...
                <main className="flex-grow container mx-auto p-4 sm:p-6 lg:p-8 prose"> {/* 'prose' class from Tailwind CSS for styling text */}
                    ...
                    <section className="mb-8">
                        ...
                        <p>If you have any questions about this Privacy Policy, please contact us at {contactEmail}.</p> {/* Using the updated variable */}
                    </section>
